...
public class RFC2045ScalarDecodeTest {
    /*
    ...
    public void RFC2045DecodeEmptyVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(emptyVector));
    ...
    public void RFC2045DecodefVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(fVector));
    ...
    public void RFC2045DecodefoVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(foVector));
    ...
    public void RFC2045DecodefooVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(fooVector));
    ...
    public void RFC2045DecodefoobVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(foobVector));
    ...
    public void RFC2045DecodefoobaVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(foobaVector));
    ...
    public void RFC2045DecodefoobarVector() {
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(foobarVector));
    ...
    public void RFC2045DecodeZeroMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(base64RandomDataZeroMod));
    ...
    public void RFC2045DecodeOneMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(base64RandomDataOneMod));
    ...
    public void RFC2045DecodeTwoMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(base64RandomDataTwoMod));
    ...
    public void RFC2045DecodeThreeMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(base64RandomDataThreeMod));
    ...
    public void RFC2045DecodeSixtyOne() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.scalar.Base64Scalar.getMimeDecoder().decode(base64RandomDataSixtyOne));
