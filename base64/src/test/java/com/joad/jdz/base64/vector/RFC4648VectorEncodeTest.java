...
public class RFC4648VectorEncodeTest {
    /*
    ...
    public void RFC4648EncodeEmptyVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(emptyVector));
    ...
    public void RFC4648EncodefVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(fVector));
    ...
    public void RFC4648EncodefoVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(foVector));
    ...
    public void RFC4648EncodefooVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(fooVector));
    ...
    public void RFC4648EncodefoobVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(foobVector));
    ...
    public void RFC4648EncodefoobaVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(foobaVector));
    ...
    public void RFC4648EncodefoobarVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(foobarVector));
    ...
    public void RFC4648EncodeZeroMod() {
        ...
        String joadRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(randomDataZeroMod));
    ...
    public void RFC4648EncodeOneMod() {
        ...
        String joadRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(randomDataOneMod));
    ...
    public void RFC4648EncodeTwoMod() {
        ...
        String joadRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(randomDataTwoMod));
    ...
    public void RFC4648EncodeThreeMod() {
        ...
        String joadRes = new String(com.joad.jdz.base64.vector.Base64Vector.getEncoder().encode(randomDataThreeMod));
