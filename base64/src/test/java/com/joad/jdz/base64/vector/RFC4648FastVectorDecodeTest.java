...
public class RFC4648FastVectorDecodeTest {
    /*
    ...
    public void RFC4648DecodeEmptyVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(emptyVector));
    ...
    public void RFC4648DecodefVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(fVector));
    ...
    public void RFC4648DecodefoVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(foVector));
    ...
    public void RFC4648DecodefooVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(fooVector));
    ...
    public void RFC4648DecodefoobVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(foobVector));
    ...
    public void RFC4648DecodefoobaVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(foobaVector));
    ...
    public void RFC4648DecodefoobarVector() {
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(foobarVector));
    ...
    public void RFC4648DecodeZeroMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(base64RandomDataZeroMod));
    ...
    public void RFC4648DecodeOneMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(base64RandomDataOneMod));
    ...
    public void RFC4648DecodeTwoMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(base64RandomDataTwoMod));
    ...
    public void RFC4648DecodeThreeMod() {
        ...
        String jdzRes = new String(com.joad.jdz.base64.vector.Base64Vector.getDecoder().decodeFast(base64RandomDataThreeMod));
